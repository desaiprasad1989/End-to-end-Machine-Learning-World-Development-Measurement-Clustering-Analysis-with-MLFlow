...
3. Data Transformation
   ...
   - 3.3 Data Cleaning. Coverted Object datatype columns to numeric, and perfomed all cleaning checks
   - 3.4 Created preprocessor using ColumnTransformer, numeric pipeline with SimpleImputer, LogTransformer and StandardScaler
